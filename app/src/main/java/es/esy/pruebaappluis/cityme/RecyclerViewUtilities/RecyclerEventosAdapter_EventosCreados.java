...
/**
 * Adaptador para el RecyclerView que muestra los eventos creados por un usuario.
 *
 * @author Luis Iglesias Muñoz
 * @version 1.0
 */
public class RecyclerEventosAdapter_EventosCreados extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    protected ArrayList<Evento> listaEventos;

    /**
     *
     * @param listaEventos lista de eventos creados por un usuario
     */
    public RecyclerEventosAdapter_EventosCreados(ArrayList<Evento> listaEventos) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_evento_creado, parent, false);
